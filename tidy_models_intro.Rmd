...
It is possible to organize a number of steps into a workflow as a form of abstraction. 
From the manual:
...
pattern. This will consume more CPU time but it could investigate a larger parameter space. 
